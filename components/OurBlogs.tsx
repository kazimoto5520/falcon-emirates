            ...
            <div className="mx-auto max-sm:mx-0 max-lg:mx-16">
                ...
                <div className="mt-12">
                    <div className="grid grid-cols-4 gap-4 max-sm:grid-cols-1 max-lg:grid-cols-2">
                        {posts.map((post) => (
                        <div key={post.id} className="flex flex-col justify-around max-w-full bg-white rounded overflow-hidden shadow-lg">
                            ...
                            <div className="px-6 py-4">
                                ...
                                <p className="text-gray-700 text-sm">{post.description.length > 15 ? post.description.substring(0,100) + '...' : post.description}</p>
                ...
                <center>
                    <div className="mt-12">
                        <Button className="uppercase bg-gray-300 rounded-xl hover:bg-main-primary hover:text-white shadow-md duration-300">More Posts</Button>
                    </div>
                </center>
